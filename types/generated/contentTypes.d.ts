...
export interface ApiEventStoryEventStory extends Struct.CollectionTypeSchema {
  collectionName: 'event_stories';
  info: {
    displayName: 'Event Story';
    pluralName: 'event-stories';
    singularName: 'event-story';
  };
  options: {
...
export interface ApiEventEvent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    event_stories: Schema.Attribute.Relation<
      'oneToMany',
      'api::event-story.event-story'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiHeroStoryHeroStory extends Struct.CollectionTypeSchema {
  collectionName: 'hero_stories';
  info: {
    displayName: 'Hero Story';
    pluralName: 'hero-stories';
    singularName: 'hero-story';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiHeroHero extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    portrait_card: Schema.Attribute.Media<'images' | 'files'> &
      Schema.Attribute.Required;
    prestige: Schema.Attribute.Media<'images' | 'files'> &
      Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    ...
    silhouette: Schema.Attribute.Media<'images' | 'files'> &
      Schema.Attribute.Required;
    slug: Schema.Attribute.UID<'nick'> & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiLocationStoryLocationStory
  extends Struct.CollectionTypeSchema {
  collectionName: 'location_stories';
  info: {
    displayName: 'Location Story';
    pluralName: 'location-stories';
    singularName: 'location-story';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiSeasonStorySeasonStory extends Struct.CollectionTypeSchema {
  collectionName: 'season_stories';
  info: {
    displayName: 'Season Story';
    pluralName: 'season-stories';
    singularName: 'season-story';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiSeasonSeason extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    season_stories: Schema.Attribute.Relation<
      'oneToMany',
      'api::season-story.season-story'
    >;
    slug: Schema.Attribute.UID<'title'> & Schema.Attribute.Required;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::event-story.event-story': ApiEventStoryEventStory;
      'api::event.event': ApiEventEvent;
      'api::global.global': ApiGlobalGlobal;
      'api::hero-story.hero-story': ApiHeroStoryHeroStory;
      'api::hero.hero': ApiHeroHero;
      'api::item.item': ApiItemItem;
      'api::location-story.location-story': ApiLocationStoryLocationStory;
